...
function BarberVaultMockup() {
  return (
    <div className="w-full h-full bg-[#0a0a0a] rounded-xl overflow-hidden border border-white/10 p-4">
      ...
      {/* Phone + notifications side by side on mobile, phone standalone on desktop */}
      <div className="mt-3 flex gap-3 items-start">
        {/* Phone mockup */}
        <div className="w-[90px] sm:w-[110px] flex-shrink-0">
        ...
        {/* Notification strip stacked beside phone */}
        <div className="flex-1 grid grid-cols-1 gap-1.5 self-center">
          {notifications.map((n) => (
            <motion.div
              ...
              className="flex items-center gap-2 rounded-md border border-white/8 bg-[#111] px-2.5 py-2"
            >
  ...
  return (
    <section id="projects" className="relative py-16 md:py-32 px-4 md:px-6 overflow-x-hidden z-10">
      ...
      <motion.img
        ...
        className="absolute -top-20 md:-top-28 left-4 md:left-auto md:right-12 z-[1] h-44 sm:h-56 md:h-72 w-auto object-contain object-top pointer-events-none select-none"
      />
